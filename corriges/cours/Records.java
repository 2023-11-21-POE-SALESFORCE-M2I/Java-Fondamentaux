...
record PointPerso(double x, double y) {
    ...
    public PointPerso(double x, double y) {
      this.x = x;
      this.y = y;
    }
...
public class Records {
    public static void main(String[] args) {
        ...
        PointSansRecords psd1 = new PointSansRecords();
        ...
        System.out.println("Egalite : " + ps1.equals(ps2));
        ...
        System.out.println("Egalite : " + pp1.equals(pp2));
